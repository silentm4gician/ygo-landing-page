...
const HowTo = () => 
{
    return (
        <div className="w-[30%] sm:w-[50%] p-4 bg-gradient-to-b from-transparent from-1% via-stone-950 via-50% to-transparent to-99% rounded-lg">
            <h2 className="text-center text-xl font-semibold bg-gradient-to-l from-transparent from-1% via-stone-950 via-50% to-transparent to-99% rounded-lg p-2 w-[100%] ">How To Play</h2>
